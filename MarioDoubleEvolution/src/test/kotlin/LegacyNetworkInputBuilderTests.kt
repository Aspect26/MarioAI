...
import cz.cuni.mff.aspect.legacy.LegacyNetworkInputBuilder
import org.junit.Assert.assertEquals
import org.junit.Test

class LegacyNetworkInputBuilderTests {
    ...
    fun givenDenseBuilderWithTiles(tilesArray: Array<Array<Tile>>, marioPosition: Pair<Int, Int> = Pair(1, 1), marioInTilePosition: Pair<Int, Int> = Pair(0, 0)): LegacyNetworkInputBuilder {
        val tiles = Tiles()
    ...
    fun givenDenseBuilderWithEntities(entitiesArray: Array<Array<List<Entity<Sprite>>>>, marioPosition: Pair<Int, Int> = Pair(1, 1), marioInTilePosition: Pair<Int, Int> = Pair(0, 0)): LegacyNetworkInputBuilder {
        val entities = Entities()
    ...
    fun givenNetworkInputBuilder(tiles: Tiles, entities: Entities, mario: MarioEntity): LegacyNetworkInputBuilder {
        return LegacyNetworkInputBuilder()
            .tiles(tiles)
            .entities(entities)
            .mario(mario)
